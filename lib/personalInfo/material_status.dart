...
import 'package:loan_app/personalInfo/email_id.dart';
...
class _materialStatus extends State<MaterialStatus> {
    ...
    if (_key.currentState.validate()) {
      ...
      Navigator.pushReplacement(
          ...
          PageTransition(
              ...
              child: EmailIdClass(userName: widget.userName,userStatus: _controller.text,)));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        body: SafeArea(
            child:
            Form(key: _key,autovalidate: _validate,
                                          ...
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                validator: ValidationData.materialValidate,
